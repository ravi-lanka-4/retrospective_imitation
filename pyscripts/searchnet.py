...
def getRankModel(inp_dim, l1=64, l2=64, l3=64):
  ...
  node1score = ranknet(node1)
  node2 = Input(shape = (inp_dim, ), dtype = "float32")
  node2score = ranknet(node2)
  ...
  ada = keras.optimizers.Adagrad(lr=0.001, epsilon=None, decay=10**-5)
