...
#SCIPDIR          = ../scip-6.0.2-affected/
SCIPDIR         = ./dep/scip-4.0.1-affected/
...
CMAINOBJ	=	nodesel_oracle.o \
			nodesel_dagger_withUCT.o \
			nodesel_policy_withUCT.o \
			nodepru_oracle.o \
			nodepru_dagger.o \
			nodepru_policy.o \
			helper.o \
...
CXX		=  clang++
FLAGS		+= -Wall -std=c++14 -O3 -I/usr/local/include/
CXXFLAGS	=  -std=c++14
LDFLAGS		+=
...
$(MAINFILE):	$(BINDIR) $(OBJDIR) $(SCIPLIBFILE) $(LPILIBFILE) $(NLPILIBFILE) $(MAINOBJFILES)
		...
		$(LINKCXX_L)$(SCIPDIR)/lib $(LINKCXX_l)$(SCIPLIB)$(LINKLIBSUFFIX) \
                ...
                $(OFLAGS) $(LPSLDFLAGS) \
		$(LDFLAGS) $(LINKCXX_o)$@ -L/usr/local/lib/
